...
public class ListArray {
	...
	public static void main(String[] args) {
		...
		// Imprimir
		System.out.println("List Array completo:" + numeros);
		
		//Vaciar
		numeros.clear();  //comentar esta linea para poder probar el resto
		
		//Ver si está vacío
		System.out.println("List Array vacio?:" + numeros.isEmpty());
				
		//Tamaño
		System.out.println("Tamaño List Array?: " + numeros.size());
				
		//Recorrer
		System.out.println("Recorrer Array List");
